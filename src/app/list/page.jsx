...
/**
 * Props:
 *  - image: string (URL or public path) -> used directly in <img src={image} />
 *  - title: string
 *  - price: number | string
 *  - description: string (optional)
 *  - onClick: function -> called when "Buy Now" is clicked
 */
  ...
  return (
    <div className="relative w-80 rounded-2xl shadow-xl overflow-hidden bg-gray-900 text-gray-100">
      ...
      <div className="relative h-64 w-full bg-gray-800">
        ...
        <img src="https://images.unsplash.com/photo-1629367494173-c78a56567877?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=927&q=80" alt={title} className="h-full w-full object-cover object-center" />
      </div>
      ...
      <div className="p-5">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h3 className="text-lg font-semibold leading-tight">Nothing Phone</h3>
            {description && <p className="mt-1 text-sm text-gray-300">Nothing phone a is the best</p>}
          </div>
